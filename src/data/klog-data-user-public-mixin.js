...
const KlogDataUserPublicMixin = (superClass) => class extends KlogDataMixin(superClass) {
    ...
    loadUserPublic(userPublicId) {
        ...
        // userPublic.select(['avatarUrl', 'displayName', 'introduction', 'license', 'username', 'zoneThemeColor']);
    ...
    loadUserPublicByUsername(username) {
        ...
        query.select(['avatarUrl', 'displayName', 'introduction', 'license', 'username', 'zoneThemeColor']);
