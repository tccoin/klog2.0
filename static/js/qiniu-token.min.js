var CryptoJS = CryptoJS || function(t, e) {
    var n = {},
        r = n.lib = {},
        i = function() {},
        s = r.Base = { extend: function(t) { i.prototype = this;
                var e = new i;
                return t && e.mixIn(t), e.hasOwnProperty("init") || (e.init = function() { e.$super.init.apply(this, arguments) }), e.init.prototype = e, e.$super = this, e }, create: function() {
                var t = this.extend();
        ...
        o = r.WordArray = s.extend({ init: function(t, n) { t = this.words = t || [], this.sigBytes = n != e ? n : 4 * t.length }, toString: function(t) {
                ...
                var e = this.words,
                    n = this.sigBytes;
                e[n >>> 2] &= 4294967295 << 32 - 8 * (n % 4), e.length = t.ceil(n / 4) }, clone: function() {
        ...
        h = a.Latin1 = { stringify: function(t) {
                var e = t.words;
                t = t.sigBytes;
                ...
                return new o.init(n, e) } },
        f = a.Utf8 = { stringify: function(t) {
                try {
                    return decodeURIComponent(escape(h.stringify(t))) } catch (e) {
                    throw Error("Malformed UTF-8 data") } }, parse: function(t) {
                return h.parse(unescape(encodeURIComponent(t))) } },
        u = r.BufferedBlockAlgorithm = s.extend({ reset: function() { this._data = new o.init, this._nDataBytes = 0 }, _append: function(t) { "string" == typeof t && (t = f.parse(t)), this._data.concat(t), this._nDataBytes += t.sigBytes }, _process: function(e) {
                var n = this._data,
                    r = n.words,
                    i = n.sigBytes,
                    s = this.blockSize,
                ...
                return new o.init(c, i) }, clone: function() {
                var t = s.clone.call(this);
                return t._data = this._data.clone(), t }, _minBufferSize: 0 });
    r.Hasher = u.extend({ cfg: s.extend(), init: function(t) { this.cfg = this.cfg.extend(t), this.reset() }, reset: function() { u.reset.call(this), this._doReset() }, update: function(t) {
            return this._append(t), this._process(), this }, finalize: function(t) {
            return t && this._append(t), this._doFinalize() }, blockSize: 16, _createHelper: function(t) {
            return function(e, n) {
                return new t.init(n).finalize(e) } }, _createHmacHelper: function(t) {
            return function(e, n) {
...
! function() {
    var t = CryptoJS,
        ...
        r = e.Hasher,
        i = [],
        e = t.algo.SHA1 = r.extend({ _doReset: function() { this._hash = new n.init([1732584193, 4023233417, 2562383102, 271733878, 3285377520]) }, _doProcessBlock: function(t, e) {
                ...
                n[0] = n[0] + r | 0, n[1] = n[1] + s | 0, n[2] = n[2] + o | 0, n[3] = n[3] + a | 0, n[4] = n[4] + c | 0 }, _doFinalize: function() {
                var t = this._data,
                    e = t.words,
                    n = 8 * this._nDataBytes,
                    r = 8 * t.sigBytes;
                return e[r >>> 5] |= 128 << 24 - r % 32, e[(r + 64 >>> 9 << 4) + 14] = Math.floor(n / 4294967296), e[(r + 64 >>> 9 << 4) + 15] = n, t.sigBytes = 4 * e.length, this._process(), this._hash }, clone: function() {
...
function() {
    var t = CryptoJS,
        e = t.enc.Utf8;
    t.algo.HMAC = t.lib.Base.extend({ init: function(t, n) { t = this._hasher = new t.init, "string" == typeof n && (n = e.parse(n));
            var r = t.blockSize,
                i = 4 * r;
            ...
            s.sigBytes = o.sigBytes = i, this.reset() }, reset: function() {
            var t = this._hasher;
            t.reset(), t.update(this._iKey) }, update: function(t) {
            return this._hasher.update(t), this }, finalize: function(t) {
            var e = this._hasher;
            return t = e.finalize(t), e.reset(), e.finalize(this._oKey.clone().concat(t)) } }) }();
var qiniuToken = { config: { access_key: "", secret_key: "", bucketname: "" }, getFlags: function() {
        ...
        return e }, byteArrayToString: function(t) {
        var e, n = "",
            r = t.length;
        for (e = 0; r > e; e++) n += String.fromCharCode(t[e]);
        return n }, urlsafeBase64EncodeFlag: function() {
        return this.base64_encode(JSON.stringify(this.getFlags())) }, wordsToByteArray: function(t) {
        var e, n = [];
        for (e = 0; e < 32 * t.length; e += 8) n.push(t[e >>> 5] >>> 24 - e % 32 & 255);
        return n }, base64ToUrlSafe: function(t) {
        return t.replace(/\//g, "_").replace(/\+/g, "-") }, getToken: function() {
        ...
        return s }, byteArrayToString: function(t) {
        var e, n = "",
            r = t.length;
        for (e = 0; r > e; e++) n += String.fromCharCode(t[e]);
        return n }, base64_encode: function(t) {
        for (var e, n, r, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", s = 0, o = t.length, a = ""; o > s;) {
            if (e = 255 & t.charCodeAt(s++), s == o) { a += i.charAt(e >> 2), a += i.charAt((3 & e) << 4), a += "==";
                break }
            if (n = t.charCodeAt(s++), s == o) { a += i.charAt(e >> 2), a += i.charAt((3 & e) << 4 | (240 & n) >> 4), a += i.charAt((15 & n) << 2), a += "=";
                break }
