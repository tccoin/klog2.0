const containerKatexStyle = document.createElement('template');

containerKatexStyle.innerHTML = `<dom-module id="katex-style">
  <template>
    <style>
      .katex-display {
        display: block;
...
document.head.appendChild(containerKatexStyle.content);
